            ...
            */
            ...
            leftPanel: function (element) {
                ...
                var ganttLeftPanel = $('<div class="leftPanel"/>')
                    ...
                    //gw .css("height", tools.getCellSize() * element.headerRows + "px")
                    .css("height", tools.getCellSize() * 2 + "px")
                    .css("width", "100%"));
                            ...
                            */
                            ...
                            if (rgetDay !== getDay) {
                                ...
                                dayArr.push('<div class="row date ' + day_class2 + '" '
                                        + ' style="display:none;width: ' + tools.getCellSize() * hoursInDay + 'px;"> '
                            ...
                            horArr.push('<div style="display:none;" class="row day ' 
                                    + day_class
                                    + '" id="dh-'
                                    + rday.getTime()
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            switch (settings.scale) {
                                case "hours":
                                    ...
                                    //gw var top = tools.getCellSize() * 5 + 2 + parseInt(topEl.attr("offset"), 10);
                                ...
                                case "weeks":
                                    ...
                                    //gw var top = tools.getCellSize() * 3 + 2 + parseInt(topEl.attr("offset"), 10);
                                    var top = tools.getCellSize() * 1 + 2 + parseInt(topEl.attr("offset"), 10);
                                    _bar.css({ 'margin-top': top, 'margin-left': Math.floor(cFrom) });
                                ...
                                case "months":
                                    ...
                                    //gw var top = tools.getCellSize() * 2 + 2 + parseInt(topEl.attr("offset"), 10);
                                ...
                                default:
                                    ...
                                    //gw var top = tools.getCellSize() * 4 + 2 + parseInt(topEl.attr("offset"), 10);
