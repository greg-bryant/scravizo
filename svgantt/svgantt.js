...
//
SVGantt.prototype.ShowPage = function(pg)
{
...
SVGantt.prototype.Reset = function()
{
	var div_name = this['div_gantt'];
        var div = document.getElementById(div_name);

}

SVGantt.prototype.AddItems = function(items, clear)
{
	var parent = this['div_gantt'];
